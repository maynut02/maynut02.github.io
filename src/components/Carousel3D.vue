...
<template>
  <div ref="carouselContainer" :class="cn('relative h-[60vh] w-full', props.containerClass)">
    <div
      :class="cn('absolute top-[40%] left-0 z-100 h-[80%] w-full -translate-y-1/2', props.class)"
